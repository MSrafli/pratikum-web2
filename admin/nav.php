<ul class="list-group">
    ...
    <li class="list-group-item"><a href="?page=mahasiswa-show">Data Matakuliah</a></li>
    <li class="list-group-item"><a href="?page=mahasiswa-add">Tambah Data Matakuliah</a></li>
    <?php
    // session_start();
